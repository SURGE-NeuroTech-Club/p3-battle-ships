...
//     {
//         int rawCode = Serial.read();
//         int durLow  = Serial.read();
//         int durHigh = Serial.read();
...
//         // Clear any remaining bytes in buffer to prevent misalignment
...
void loop()
{
    if (Serial.available() >= 3)
    {
        ...
        // DEBUG: Echo back what was received
